...
**Warning**: This part implements a previous version of [MSC2965], which was slightly different.
The updated proposal isn't yet implemented by clients and servers. The rest of the flow remains unchanged.
