...
![Discovery with legacy fallback](./discovery-with-fallback.png)

![Discovery without legacy fallback](./discovery-without-fallback.png)
...
![Example with legacy fallback](./account-management.png)
