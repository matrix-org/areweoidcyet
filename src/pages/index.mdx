...
| Proposal                                                                                  | Status                                     |
| ----------------------------------------------------------------------------------------- | ------------------------------------------ |
| [MSC3861]: Next-generation auth for Matrix, based on OAuth 2.0/OIDC                       | 🚀 Merged!                                 |
| [MSC2964]: Usage of OAuth 2.0 authorization code grant and refresh token grant            | 🚀 Merged!                                 |
| [MSC2965]: Usage of OpenID Connect Discovery for authentication server metadata discovery | 🚀 Merged!                                 |
| [MSC2966]: Usage of OAuth 2.0 Dynamic Client Registration in Matrix                       | 🚀 Merged!                                 |
| [MSC2967]: API scopes                                                                     | 🚀 Merged!                                 |
| [MSC4254]: Usage of RFC7009 Token Revocation for Matrix client logout                     | 🚀 Merged!                                 |
| [MSC3824]: OIDC aware clients                                                             | 🚀 Merged!                                 |
| [MSC4108]: Mechanism to allow OIDC sign in and E2EE set up via QR code                    | 🚧 Reworrk in progress                     |
| [MSC4190]: Device management for application services                                     | 🚀 Merged!                                 |
| [MSC4191]: Account management deep-linking                                                | 🚀 Merged!                                 |
...
There are a few areas not yet written down in MSCs, some need more thinking:
 ...
 - **Encrypted application-services** currently rely on `/login` with the `m.login.application_service` method to *create devices*, which has been infamously removed from the implementation in Synapse/MAS. An alternative API to create devices is proposed in [MSC4190], which is supported by some application services.
...
| [Tuwunel]      | ✅ Supported \| [Docs][uwu-hs-doc] |
...
[uwu-hs-doc]: https://matrix-construct.github.io/tuwunel/authentication/oidc-server.html
