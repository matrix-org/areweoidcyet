...
| Requirement                                                                       |                               | Relevant spec(s)                                                                                                                                                                     | [Hydrogen](https://github.com/sandhose/hydrogen-web/tree/sandhose/oidc-login) | [Files SDK Demo](https://github.com/vector-im/files-sdk-demo/tree/oidc) | Element Web | Element iOS/Android | [Element X iOS](https://github.com/vector-im/element-x-ios) | [Element X Android](https://github.com/vector-im/element-x-android) | [Third Room](https://github.com/matrix-org/thirdroom) |
| --------------------------------------------------------------------------------- | ----------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------- | ----------------------------------------------------------------------- | ----------- | ------------------- | ----------------------------------------------------------- | ------------------------------------------------------------------- | ----------------------------------------------------- |
