...
---
[![Matrix](/assets/images/matrix-logo-white.svg)](https://matrix.org){: .logo} _Last updated: 2023-09-13
...
| Provisioning of Matrix device                                                                    | MSC2964                                                                             | REQUIRED    | ✅                                                                                                              | ❌           |
| Provision Matrix user based on token introspection                                               |                                                                                     | REQUIRED    | ✅                                                                                                              | ❌           |
| Enforce base user scope                                                                          | MSC2967                                                                             | REQUIRED    | ✅                                                                                                              | ❌           |
| Handling of guest scope                                                                          | MSC2967                                                                             | REQUIRED    | ✅                                                                                                              | ❌           |
...
| Receive and process account deletion from OP                                                     |                                                                                     | REQUIRED    | ✅ [Using admin API](https://matrix-org.github.io/synapse/latest/admin_api/user_admin_api.html#delete-a-device) | ❌           |
...
| Dynamic client registration                                                       | REQUIRED for open Homeservers | [MSC2965](https://github.com/matrix-org/matrix-spec-proposals/pull/2965) and [RFC7591 OAuth 2.0 Dynamic Client Registration Protocol](https://datatracker.ietf.org/doc/html/rfc7591) | ✅                                                                            | ✅                                                                      | ❌          | 🚫                 | ✅                                                          | ✅                                                                  | ✅                                                    |
| Login flow - no `prompt` param                                                    | REQUIRED                      | [RFC6749 Authorization Code Grant](https://www.rfc-editor.org/rfc/rfc6749#section-1.3.1)                                                                                             | ✅                                                                            | ✅                                                                      | ❌          | 🚫                 | ✅                                                          | ✅                                                                  | ✅                                                    |
| Sign up flow - `prompt=create`                                                    | RECOMMENDED                   | [Initiating User Registration via OpenID Connect 1.0](https://openid.net/specs/openid-connect-prompt-create-1_0.html)                                                                | ✅                                                                            | ✅                                                                      | ❌          | 🚫                 | ❌                                                          | ❌                                                                  | ✅                                                    |
| Refresh token handling                                                            | REQUIRED                      | [OpenID Connect Core 1.0](https://openid.net/specs/openid-connect-core-1_0.html)                                                                                                     | ✅                                                                            | ✅                                                                      | ❌          | 🚫                 | ✅                                                          | ✅                                                                  | ✅                                                    |
| Sign out - Token revocation                                                       | REQUIRED                      | [RFC7009 Token Revocation](https://datatracker.ietf.org/doc/html/rfc7009)                                                                                                            | ✅                                                                            | ✅                                                                      | ❌          | 🚫                 | ✅                                                          | ✅                                                                  | ✅                                                    |
| Sign out - RP-Initiated Logout                                                    | REQUIRED                      | [RP-Initiated Logout 1.0](https://openid.net/specs/openid-connect-rpinitiated-1_0.html)                                                                                              | ✅                                                                            | ❌                                                                      | ❌          | 🚫                 | ❌                                                          | ❌                                                                  | ❌                                                    |
...
| OP => HS notification of sign out                                                                                                                             | Session/device management                                                                                                                         | REQUIRED    | ✅                                                                                                  | ❌ Would need a keycloak event listener that then made outbound HTTP requests in some format supported by the HS                  | TODO: look at extension points in Okta                                                                                                                                                | 🚧 Requires a post-logout trigger for Actions  | Use <a href="https://auth0.com/docs/customize/log-streams/custom-log-streams">https://auth0.com/docs/customize/log-streams/custom-log-streams</a> to push events to HS   |
| OP => HS notification of deactivation                                                                                                                         |                                                                                                                                                   | REQUIRED    | ✅                                                                                                  | ✅ Via event listener                                                                                                             | ❌ TODO: look at extension points in Okta                                                                                                                                             | 🚧 Requires a deactivation trigger for Actions | ❌ Use<a href="https://auth0.com/docs/customize/log-streams/custom-log-streams">https://auth0.com/docs/customize/log-streams/custom-log-streams</a> to push events to HS |
| <a href="https://datatracker.ietf.org/doc/html/rfc7009">RFC7009 Token Revocation</a>                                                                          | Allow Matrix client to logout their own session                                                                                                   | REQUIRED    | ✅                                                                                                  | ✅                                                                                                                                | ✅                                                                                                                                                                                    | ✅                                              | ✅<a href="https://auth0.com/docs/secure/tokens/refresh-tokens/revoke-refresh-tokens">But, refresh tokens only</a>                                                       |
...
| Web UI for managing sessions                                                                                                                                  | Can optionally use an id_token_hint param as detailed in<a href="https://github.com/matrix-org/matrix-spec-proposals/pull/2965">MSC2965</a>       | RECOMMENDED | ✅                                                                                                  | ✅ User Account Service                                                                                                           | ✅                                                                                                                                                                                    | ✅                                              | ❌                                                                                                                                                                       |
...
| <a href="https://matrix-org.github.io/synapse/latest/openid.html">Support for upstream OpenID Provider</a>                                                    | Single Sign On/social login                                                                                                                       | OPTIONAL    | ✅                                                                                                  | ✅                                                                                                                                | ✅                                                                                                                                                                                    | ✅                                              | ✅                                                                                                                                                                       |
| <a href="https://matrix-org.github.io/synapse/latest/usage/configuration/user_authentication/single_sign_on/saml.html">Support for upstream SAML provider</a> | Single Sign On                                                                                                                                    | OPTIONAL    | 🚫 Out of scope                                                                                    | ✅                                                                                                                                | ✅                                                                                                                                                                                    | ✅                                              | ✅                                                                                                                                                                       |
| <a href="https://matrix-org.github.io/synapse/latest/usage/configuration/user_authentication/single_sign_on/cas.html">Support for upstream CAS provider</a>   | Single Sign On                                                                                                                                    | OPTIONAL    | 🚫 Out of scope                                                                                    | ?                                                                                                                                 | ?                                                                                                                                                                                     | ❌                                              | ?                                                                                                                                                                        |
